...
*               VIEW 의 경로가 정해져 있다. (String : 뷰의 논리적인 경로)
*
...
public class ExamController {
    ...
    //  의존성 주입 : 클래스 간의 관계를 형성, 스프링이 관리하는 객체를 하나의 객체가 다른 객체의 의존성을 제공하는 테크닉
    ...
    /**
     * @RequestParam(name="요청 시의 키" value=name의 별칭, required=요청 시의 쿼리스트링 필수여부(true, false), defaultValue="기본값") 쿼리스트링 바인딩하는
     * @param Member member -> 커맨트객체(controller 계층)
    ...
    public ModelAndView exam2() {
        ...
        mav.addObject("title", "예제2");  //  화면에 전달할 data를 세팅하는 방법
    ...
    /*
    * @GetMapping : GET 방식의 HTTP 주소요청 시 특정핸들러 메소드와 맵핑시켜주는 어노테이션
